...
/**
 * Fixed version of WordPressSitesList that avoids the problematic child components
 * This version works around React error #301 by removing complex dependencies
 */
function WordPressSitesListFixed(): React.JSX.Element {
...
export default WordPressSitesListFixed;
