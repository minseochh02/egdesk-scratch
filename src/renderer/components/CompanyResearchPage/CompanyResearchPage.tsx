          ...
          <div className="cr-main">
            ...
            <section className="cr-search-section">
              <div className="cr-search-box">
                <div className="cr-input-mode-row" role="tablist" aria-label="How to look up the company">
                  <button
                    type="button"
                    role="tab"
                    aria-selected={lookupMode === 'website'}
                    className={`cr-mode-tab${lookupMode === 'website' ? ' cr-mode-tab--active' : ''}`}
                  ...
                  <button
                    ...
                    className={`cr-mode-tab${lookupMode === 'companyName' ? ' cr-mode-tab--active' : ''}`}
                ...
                <div className="cr-action-buttons">
                  ...
                  <>
                    <p className="cr-register-hint">
                      Register a company using its display or legal name. Saving and automation will connect here in a later update.
                    </p>
                    <div className="cr-input-wrapper">
                      <span className="cr-input-icon">🏢</span>
                      <input
