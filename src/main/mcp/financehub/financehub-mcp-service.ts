        ...
        inputSchema: {
          ...
          properties: {
            tableSlug: {
              type: 'string',
              description:
                'Required. Table slug from financehub_list_bank_product_tables (e.g. "ibk_b2b_receivables", "woori_b2b_loan_executions", "ibk_endorsements", "ibk_loan_history", "hana_loan_history").'
            },
            filters: {
              type: 'array',
              description:
