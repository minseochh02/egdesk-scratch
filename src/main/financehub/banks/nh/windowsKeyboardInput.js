 ...
 * @param {string} [passwordSelector] - XPath selector for password field (defaults to NH Bank selector)
 ...
 * @returns {Promise<Object>} Result object
 */
async function typePasswordWithFill(page, password, delays, log, passwordSelector = '//input[@id="loginUserPwd"]') {
  try {
 ...
 * @returns {Promise<Object>} Result object
 */
async function typePasswordWithClipboard(page, password, delays, log, passwordSelector = '//input[@id="loginUserPwd"]') {
  try {
 ...
 * @returns {Promise<Object>} Result object
 */
async function handleWindowsPasswordInput(page, password, delays, log, preferredMethod = 'auto', passwordSelector = '//input[@id="loginUserPwd"]') {
  if (!isWindows()) {
