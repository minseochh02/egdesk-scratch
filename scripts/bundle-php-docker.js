  ...
  try {
    ...
    try {
      ...
      try {
        ...
        throw new Error(
          'Docker Compose not available. Please install Docker Desktop or Docker Compose.',
        );
      }
    }
...
`;
      ...
      console.error(
        '❌ Failed to create macOS Intel placeholder:',
        error.message,
      );
    }
    ...
    console.log(
      '4. On Apple Silicon Macs, you might need: docker run --platform linux/amd64 hello-world',
    );
